...
//                       <div className="text-xs text-slate-500">{tx.amount !== '-' ? tx.amount : 'N/A'}</div>
//                     </td>
//
//                     {/* Date */}
...
//             <button className="text-sm text-slate-500 hover:text-blue-400 transition">
